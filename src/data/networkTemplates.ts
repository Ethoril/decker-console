...
export const NETWORK_TEMPLATES: NetworkTemplate[] = [
  {
    ...
    data: {
      ...
      icons: {
        patrol: { kind: 'ice', nodeId: 'router', iceType: 'patrouilleuse', revealed: false, visibleToPlayer: true, label: 'Sentinelle locale', condition: 6 },
      },
      decker: { nodeId: 'entry' },
    },
  },
  {
    ...
    data: {
      ...
      icons: {
        patrol: { kind: 'ice', nodeId: 'gate', iceType: 'patrouilleuse', revealed: false, visibleToPlayer: true, label: 'Watchdog', condition: 6 },
        blocker: { kind: 'ice', nodeId: 'security', iceType: 'bloqueuse', revealed: false, visibleToPlayer: false, label: 'Lockjaw', condition: 6 },
  ...
  },
  {
    ...
    data: {
      ...
      icons: {
        trace: { kind: 'ice', nodeId: 'trace', iceType: 'traceuse', revealed: false, visibleToPlayer: false, label: 'Limier', condition: 6 },
        tar: { kind: 'ice', nodeId: 'inner', iceType: 'potDeColle', revealed: false, visibleToPlayer: false, label: 'Goudron', condition: 6 },
        black: { kind: 'ice', nodeId: 'black', iceType: 'noire', revealed: false, visibleToPlayer: false, label: 'Ange noir', condition: 8 },
        killer: { kind: 'ice', nodeId: 'vault', iceType: 'tueuse', revealed: false, visibleToPlayer: false, label: 'Cerbère', condition: 8 },
